...
export default function BlogPosts({
  title =
    "Quer saber como fazer <b>pratos irresistíveis com nossos produtos?</b> Confira nossos vídeos com algumas receitas exclusivas que vão transformar seu cardápio:",
  posts = [
    {
      title: "Pizza com queijo muçarela Vida Veg",
      image: DEFAULT_IMAGE,
      videoLink:
        "https://www.youtube.com/embed/vhc4a3QbAcY?si=NuJMY-DP_D3PQ6Jk",
    },
    {
      title: "Pizza com queijo muçarela Vida Veg",
      image: DEFAULT_IMAGE,
