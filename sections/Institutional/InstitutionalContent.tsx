...
interface InstitutuonalContentProps {
  /**
   * @title Adicione novos menus
   */
  menus?: MenuInstitutionalProps[];
  /**
   * @title Configurar conteúdo institucional
   */
...
const InstitutuonalContent = ({ menus, title, content }: InstitutuonalContentProps) => {
  return (
      ...
      <div class="flex flex-col gap-5 lg:flex-row lg:gap-20">
        ...
        <div class={"lg:w-3/4"}>
          ...
          <div class="flex flex-col justify-start gap-6">
            <h2 class="lg:text-2xl font-bold text-base-300">{title}</h2>
            <div class="font-normal text-sm text-base-300" dangerouslySetInnerHTML={{ __html: content }} />
          </div>
        </div>
      </div>
    </div>
